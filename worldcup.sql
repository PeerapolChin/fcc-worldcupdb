...
--
-- Name: games fk_oppo_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_oppo_id FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
